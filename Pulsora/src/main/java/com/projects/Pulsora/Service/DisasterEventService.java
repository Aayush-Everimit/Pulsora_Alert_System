...
public class DisasterEventService {
    ...
    public DisasterEvent createDisasterEventFromExternal(ExEventDto dto) {
        DisasterEvent event = new DisasterEvent();
        event.setEventType(dto.getEventType());
        event.setLocation(dto.getLocation());
        event.setMagnitude(dto.getMagnitude());
        event.setSeverity(DisasterEvent.Severity.valueOf(dto.getSeverity()));
    ...
    public boolean existsByExternalId(String externalId) {
        return disasterEventRepository.existsByExternalId(externalId);
    }
}
